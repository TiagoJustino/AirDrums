...
public class Tutorial4Script : MonoBehaviour {
    ...
    public void initialize()
    {
        ...
        notePosition[0] = new Vector3(3.432547f, 3.077803f, 7.996204f);
        notePosition[1] = new Vector3(2.492673f, 3.077803f, 7.996204f);
        notePosition[2] = new Vector3(1.507733f, 3.077803f, 7.996204f);
        notePosition[3] = new Vector3(0.5323566f, 3.077803f, 7.996204f);
        notePosition[4] = new Vector3(-0.4145995f, 3.077803f, 7.996204f);
        notePosition[5] = new Vector3(-1.344433f, 3.077803f, 7.996204f);
        notePosition[6] = new Vector3(-2.348921f, 3.077803f, 7.996204f);
        notePosition[7] = new Vector3(-3.32729f, 3.077803f, 7.996204f);
    }
